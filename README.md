...
----
    ...
    appcelerator/influxdb:0.9    -> influxdb 0.9.6.1
    appcelerator/influxdb:0.10    -> influxdb 0.10.3
    appcelerator/influxdb:0.12    -> influxdb 0.12.1
...
**Note**: `influxdb:0.9` is **NOT** backwards compatible with `0.8.x`. If you need version `0.8.x`, please run:
    ...
    docker run -d -p 8083:8083 -p 8086:8086 appcelerator/influxdb:0.8.8
...
```docker run -d -p 8083:8083 -p 8086:8086 -p 2015:2015 -e ADMIN_USER="root" -e INFLUXDB_INIT_PWD="somepassword" -e PRE_CREATE_DB=my_db -e GRAPHITE_DB="my_db" -e GRAPHITE_BINDING=':2015' -e GRAPHITE_PROTOCOL="udp" -e GRAPHITE_template="tag1.tag2.tag3.measurement*" appcelerator/influxdb```
...
```docker run -d -p 8083:8083 -p 8086:8086 -p 25826:25826/udp -e ADMIN_USER="root" -e INFLUXDB_INIT_PWD="somepassword" -e PRE_CREATE_DB=my_db -e COLLECTD_DB="my_db" -e COLLECTD_BINDING=':25826' -e COLLECTD_RETENTION_POLICY="mypolicy" appcelerator/influxdb```
...
```docker run -d -p 8083:8083 -p 8086:8086 -p 4444:4444/udp --expose 8090 --expose 8099 --expose 4444 -e UDP_DB="my_db" appcelerator/influxdb```
...
docker run -p 8088:8088 -e FORCE_HOSTNAME=192.168.0.1:8088 -t appcelerator/influxdb
docker run -p 8089:8088 -e FORCE_HOSTNAME=192.168.0.1:8089 -e JOIN=192.168.0.1:8088 -t appcelerator/influxdb
```
...
docker run -p 8083:8083 -p 8086:8086 --expose 8090 --expose 8099 \
  ...
  -d --name masterinflux appcelerator/influxdb
```
